...
export enum TransportSubmodeType {
...
export const TransportSubmodeTypeEnum = z.nativeEnum(TransportSubmodeType);
export const TransportModeTypeEnum = z.nativeEnum(TransportModeType);
